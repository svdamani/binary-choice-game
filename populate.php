<?php
    ...
    {
        $prob_data[] = array($i+1, (float)rand()/(float)getrandmax(), rand()%10, rand()%10, min(1-(float)rand()/(float)getrandmax(), (float)rand()/(float)getrandmax()),
    ...
    {
        $mysql_query = "INSERT INTO sg_conditions VALUES($j";
        for($k=0; $k<6; $k++)
