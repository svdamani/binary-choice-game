		...
		<section id="signup">
			<form method="POST" onSubmit="return User.SignUp(this);" action="javascript:location='home.php'">
				<fieldset>
					...
					<input type="text" name="language" placeholder="Native Language" autocomplete="off" required />
					...
					<input type="number" name="age" placeholder="Age" min="18" max="99" autocomplete="off" required />
